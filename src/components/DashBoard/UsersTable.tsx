...
const UsersTable = () => {
  ...
  return (
    ...
    <CardHeader className="flex flex-row items-center justify-between">
      <CardTitle className="text-lg font-medium">Users Table</CardTitle>
      <CardTitle className="text-lg font-medium cursor-pointer" onClick={()=>navigate('/seeAllUsers')}>See all</CardTitle>
    </CardHeader>
    <CardContent>
